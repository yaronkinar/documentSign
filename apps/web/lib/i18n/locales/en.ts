export const en = {
  ...
  document: {
    ...
    page: 'Page {{n}}',
    signed: 'signed',
    copyFromSource: 'Copy from the original document',
    copyFromSourceValue: 'Copy from the original document: {{value}}',
  ...
  templates: {
    ...
    uploadTitle: 'Upload PDF templates',
    uploadSubtitle: 'Select or drop multiple PDFs. Each file becomes its own template.',
    pdfFilesLabel: 'PDF files',
    dropzone: 'Click to browse or drag PDFs here',
    dropzoneHint: 'Multiple files supported',
    untitled: 'Untitled template',
    pdfOnly: 'Please choose PDF files only.',
    nameRequired: 'Every template needs a name.',
    uploadingProgress: 'Uploading {{current}} of {{total}}: {{name}}',
    uploadFailedFor: 'Upload failed for "{{name}}": {{status}}',
    uploadFailed: 'Upload failed',
    createdWithFailures: 'Created {{count}} template(s). Failed: {{failures}}',
    createAndPlace: 'Create & place fields',
    createMany: 'Create {{count}} templates',
    emptyTitle: 'No templates yet.',
    uploadFirst: 'Upload your first templates',
    ...
    editor: {
      ...
      placeHint: 'Click anywhere on the PDF to place a field',
      noPdf: 'No PDF uploaded for this template.',
      backToTemplates: 'Back to templates',
      nameLabel: 'Template name',
      setDefault: 'Set as default template',
      addField: '+ Add field',
      addFormField: '+ Add form field',
      clickOnPdf: 'Click on PDF to place…',
      aiExtracting: 'AI is extracting…',
      aiExtractFields: 'AI extract fields',
      aiExtractFormFields: 'AI extract form fields',
      selectedField: 'Selected field',
      labelLabel: 'Label',
      position: 'Page {{page}} · ({{x}}%, {{y}}%)',
      size: 'Size: {{width}}% × {{height}}%',
      removeField: 'Remove field',
      fieldsCount: 'Fields ({{count}})',
      noFieldsYet: 'No fields yet. Click "+ Add field" then click on the PDF.',
      formFieldsCount: 'Form fields ({{count}})',
      noFormFieldsYet: 'No form fields yet. Click "+ Add form field" then click on the PDF.',
      untitledField: 'Untitled',
      pageAbbrev: 'p.{{page}}',
      typeText: 'Text',
      ...
      replaceConfirm: 'Replace the current draft fields with AI-detected fields?',
      aiNoFields: 'AI did not find any fields in this PDF.',
      fieldDefaultLabel: 'Field {{n}}',
      extractFailed: 'Failed to extract fields',
      extractFormFieldsFailed: 'Failed to extract form fields',
      saveFailed: 'Failed to save',
      addFieldFailed: 'Failed to add field',
      moveFieldFailed: 'Failed to move field',
      resizeFieldFailed: 'Failed to resize field',
